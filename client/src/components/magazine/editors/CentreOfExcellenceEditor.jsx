  ...
  return (
    <div className="space-y-5">
      ...
      <div>
        ...
        <ImageUploader images={photos} onChange={setPhotos} label="Upload Centre Photos" maxImages={8} />
      </div>

      <div className="flex gap-3 pt-2">
        <button
          onClick={() => { completeSection('coe'); toast.success('Centre of Excellence section generated.'); }}
          className="btn-primary text-sm"
        >
          Generate Section
        </button>
        <button onClick={() => toast('Preview opens in Preview tab.')} className="btn-secondary text-sm">
          Preview
        </button>
      </div>
    </div>
